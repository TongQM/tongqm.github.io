...
##### Poisson
$$P(d=k)=\frac{\lambda^ke^{-\lambda}}{k!},$$ which is usually considered as the approximation of binomial distribution especially when n is large and p is a small.
##### Regular
One-point distribution, $$P(d=k)=1, P(d\ne k)=0.$$
##### Scale-free
...
##### Average Distance
Selfevidently, $$Ce_i(g)=(n-1)/\Sigma_{j\ne i}l(i,j),$$
